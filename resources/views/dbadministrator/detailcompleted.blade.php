        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ url('dbadministrator-completed') }}">Database Administrator Completed</a></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                            <a href="{{ url('dbadministrator-completed') }}" class="btn btn-secondary">
                                Back
                            </a>
                        </div>
                    </div>
