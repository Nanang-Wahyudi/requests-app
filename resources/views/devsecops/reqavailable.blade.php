        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">DevSecOps Available</div>
                </div>
            </div>
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="devsecopsAvailableTable" class="display">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Id Request</th>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            // table data
            $('#devsecopsAvailableTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('devsecops-available') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
