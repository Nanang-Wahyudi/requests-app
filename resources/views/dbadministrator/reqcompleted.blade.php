        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Database Administrator Completed</div>
                </div>
            </div>
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="dbaCompletedTable" class="display">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Id Request</th>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            // table data
            $('#dbaCompletedTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('dbadministrator-completed') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
