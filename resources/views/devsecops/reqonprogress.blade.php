        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">DevSecOps On Progress</div>
                </div>
            </div>
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="devsecopsOnProgressTable" class="display">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Id Request</th>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            // table data
            $('#devsecopsOnProgressTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('devsecops-onprogress') }}",
