...
Route::get('change-password', [UserController::class, 'formchangepassword'])->middleware(['auth']);
Route::post('change-password-process', [UserController::class, 'processchangepassword'])->middleware(['auth']);
...
Route::post('developer-request-onprogress/{id}/delete', [RequestController::class, 'devdeleterequest'])->middleware(['auth']);
